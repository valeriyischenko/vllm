...
class EngineCore:
    ...
    def _initialize_kv_caches(self, vllm_config: VllmConfig) -> KVCacheConfig:
        ...
        if has_kv_cache:
            ...
            supported_layouts: list[list[str]] = self.collective_rpc(
            ...
            if vllm_config.cache_config.enable_extensible_kv_cache and (
                ...
                if narrowed := narrow_layouts_to_block_outermost(supported_layouts):
                    ...
                    logger.info_once(
                        ...
                        "KV cache layout is supported for this model's mixed "
                        "page sizes. KV cache sizing will use profiling "
                        "estimates instead of measured usage."
                    )
                    vllm_config.cache_config.disable_extensible_kv_cache()
            layout = resolve_kv_cache_layout(supported_layouts, all_specs)
            publish_kv_cache_layout_to_current_process(
